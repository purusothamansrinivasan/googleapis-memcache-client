...
// Import Post_V1Beta2_Parent_InstancesMCPTool - included in same package
// Import Get_V1Beta2_Parent_InstancesMCPTool - included in same package
// Import Post_V1Beta2_Name_UpgradeMCPTool - included in same package
// Import Patch_V1Beta2_Name_Update_ParametersMCPTool - included in same package
// Import Post_V1Beta2_Name_Apply_ParametersMCPTool - included in same package
// Import Get_V1Beta2_NameMCPTool - included in same package
// Import Post_V1Beta2_Instance_Reschedule_MaintenanceMCPTool - included in same package
// Import Post_V1Beta2_Instance_Apply_Software_UpdateMCPTool - included in same package
// Import Post_V1Beta2_Name_CancelMCPTool - included in same package
// Import Patch_V1Beta2_NameMCPTool - included in same package
// Import Delete_V1Beta2_NameMCPTool - included in same package
// Import Get_V1Beta2_Name_LocationsMCPTool - included in same package
// Import Get_V1Beta2_Name_OperationsMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Post_V1Beta2_Parent_InstancesMCPTool.createPost_V1Beta2_Parent_InstancesTool(config),
            Get_V1Beta2_Parent_InstancesMCPTool.createGet_V1Beta2_Parent_InstancesTool(config),
            Post_V1Beta2_Name_UpgradeMCPTool.createPost_V1Beta2_Name_UpgradeTool(config),
            Patch_V1Beta2_Name_Update_ParametersMCPTool.createPatch_V1Beta2_Name_Update_ParametersTool(config),
            Post_V1Beta2_Name_Apply_ParametersMCPTool.createPost_V1Beta2_Name_Apply_ParametersTool(config),
            Get_V1Beta2_NameMCPTool.createGet_V1Beta2_NameTool(config),
            Post_V1Beta2_Instance_Reschedule_MaintenanceMCPTool.createPost_V1Beta2_Instance_Reschedule_MaintenanceTool(config),
            Post_V1Beta2_Instance_Apply_Software_UpdateMCPTool.createPost_V1Beta2_Instance_Apply_Software_UpdateTool(config),
            Post_V1Beta2_Name_CancelMCPTool.createPost_V1Beta2_Name_CancelTool(config),
            Patch_V1Beta2_NameMCPTool.createPatch_V1Beta2_NameTool(config),
            Delete_V1Beta2_NameMCPTool.createDelete_V1Beta2_NameTool(config),
            Get_V1Beta2_Name_LocationsMCPTool.createGet_V1Beta2_Name_LocationsTool(config),
            Get_V1Beta2_Name_OperationsMCPTool.createGet_V1Beta2_Name_OperationsTool(config)
            );
