/**
 * MCP Server function for Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service.
 */
...
class Get_V1Beta2_NameMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V1Beta2_NameHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v1beta2_name" + queryString;
    ...
    public static MCPServer.Tool createGet_V1Beta2_NameTool(MCPServer.APIConfig config) {
        ...
        nameProperty.put("description", "The name of the operation resource.");
        ...
        return new MCPServer.Tool(definition, getGet_V1Beta2_NameHandler(config));
    }
