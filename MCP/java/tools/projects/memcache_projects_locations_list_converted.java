/**
 * MCP Server function for Lists information about the supported locations for this service.
 */
...
class Get_V1Beta2_Name_LocationsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V1Beta2_Name_LocationsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v1beta2_name_locations" + queryString;
    ...
    public static MCPServer.Tool createGet_V1Beta2_Name_LocationsTool(MCPServer.APIConfig config) {
        ...
        nameProperty.put("description", "The resource that owns the locations collection, if applicable.");
        properties.put("name", nameProperty);
        Map<String, Object> filterProperty = new HashMap<>();
        filterProperty.put("type", "string");
        filterProperty.put("required", false);
        filterProperty.put("description", "A filter to narrow down results to a preferred subset. The filtering language accepts strings like `\"displayName=tokyo\"`, and is documented in more detail in [AIP-160](https://google.aip.dev/160).");
        ...
        pageTokenProperty.put("description", "A page token received from the `next_page_token` field in the response. Send that page token to receive the subsequent page.");
        ...
        pageSizeProperty.put("description", "The maximum number of results to return. If not set, the service selects a default.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_v1beta2_name_locations",
            "Lists information about the supported locations for this service.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_V1Beta2_Name_LocationsHandler(config));
    }
