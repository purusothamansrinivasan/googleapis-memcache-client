/**
 * MCP Server function for Updates an existing Instance in a given project and location.
 */
...
class Patch_V1Beta2_NameMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_V1Beta2_NameHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("instanceMessages")) {
            queryParams.add("instanceMessages=" + args.get("instanceMessages"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_v1beta2_name" + queryString;
    ...
    public static MCPServer.Tool createPatch_V1Beta2_NameTool(MCPServer.APIConfig config) {
        ...
        updateMaskProperty.put("description", "Required. Mask of fields to update. * `displayName`");
        ...
        return new MCPServer.Tool(definition, getPatch_V1Beta2_NameHandler(config));
    }
