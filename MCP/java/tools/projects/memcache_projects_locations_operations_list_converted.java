/**
 * MCP Server function for Lists operations that match the specified filter in the request. If the server doesn't support this method, it returns `UNIMPLEMENTED`.
 */
...
class Get_V1Beta2_Name_OperationsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V1Beta2_Name_OperationsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v1beta2_name_operations" + queryString;
    ...
    public static MCPServer.Tool createGet_V1Beta2_Name_OperationsTool(MCPServer.APIConfig config) {
        ...
        nameProperty.put("description", "The name of the operation's parent resource.");
        properties.put("name", nameProperty);
        Map<String, Object> filterProperty = new HashMap<>();
        filterProperty.put("type", "string");
        filterProperty.put("required", false);
        filterProperty.put("description", "The standard list filter.");
        ...
        pageTokenProperty.put("description", "The standard list page token.");
        ...
        pageSizeProperty.put("description", "The standard list page size.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_v1beta2_name_operations",
            "Lists operations that match the specified filter in the request. If the server doesn't support this method, it returns `UNIMPLEMENTED`.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_V1Beta2_Name_OperationsHandler(config));
    }
