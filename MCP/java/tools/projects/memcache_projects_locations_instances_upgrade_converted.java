/**
 * MCP Server function for Upgrades the Memcache instance to a newer memcached engine version specified in the request.
 */
...
class Post_V1Beta2_Name_UpgradeMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_V1Beta2_Name_UpgradeHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_v1beta2_name_upgrade" + queryString;
    ...
    public static MCPServer.Tool createPost_V1Beta2_Name_UpgradeTool(MCPServer.APIConfig config) {
        ...
        nameProperty.put("description", "Required. Memcache instance resource name using the form: `projects/{project}/locations/{location}/instances/{instance}` where `location_id` refers to a GCP region.");
        ...
        memcacheVersionProperty.put("description", "Input parameter: Required. Specifies the target version of memcached engine to upgrade to.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_v1beta2_name_upgrade",
            "Upgrades the Memcache instance to a newer memcached engine version specified in the request.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_V1Beta2_Name_UpgradeHandler(config));
    }
