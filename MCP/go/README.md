# Cloud Memorystore for Memcached API MCP Server

This MCP (Model Content Protocol) server provides access to Cloud Memorystore for Memcached API API functionality through HTTP, HTTPS, and STDIO transport modes.
